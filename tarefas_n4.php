...
$nivel = 3;
$tabela = 'questoes_nivel3'; // Alterar para a tabela correspondente ao nível 3
...
// Contar o total de questões no nível 3
...
if ($total_questoes > 0) {
    // Selecionar questões do nível 3
...
<head>
  ...
  <title>Configurações - Nível 3</title> <!-- Título modificado -->
                    ...
                    <div class="question-container">
                        ...
                        <ul>
                            <?php foreach ($questao_data['alternativas'] as $alternativa): ?>
                                <li>
                                    <input type="radio" name="alternativa" value="<?php echo $alternativa['id']; ?>" id="q3<?php echo $alternativa['id']; ?>"> <!-- Alterar ID para evitar conflitos -->
                                    <label for="q3<?php echo $alternativa['id']; ?>"><?php echo $alternativa['texto']; ?></label>
                                </li>
                            <?php endforeach; ?>
                        </ul>
...
<script src="js/tarefas.js"></script> <!-- Manter o seu arquivo JavaScript -->
</body>
</html>
