...
$total_questoes_sql = "SELECT COUNT(*) AS total FROM $tabela WHERE materia = 'Eletricidade – Eletrostática – Carga elétrica e processos de eletrização'";
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, dificuldade FROM $tabela WHERE materia = 'Eletricidade – Eletrostática – Carga elétrica e processos de eletrização' LIMIT $questoes_por_pagina OFFSET $offset";
...
$count_sql = "SELECT COUNT(*) AS total FROM $tabela WHERE materia = 'Eletricidade – Eletrostática – Carga elétrica e processos de eletrização'";
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, dificuldade
    FROM $tabela WHERE materia = 'Eletricidade – Eletrostática – Carga elétrica e processos de eletrização'";
if (count($conditions) > 0) {
...
<div class="page-container">
    <main class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <h3 class="font-weight-bold">Eletricidade – Eletrostática – Carga elétrica e processos de eletrização</h3>
        </div>
