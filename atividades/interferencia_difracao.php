...
$total_questoes_sql = "SELECT COUNT(*) AS total FROM $tabela WHERE materia = 'Interferência e difração de ondas mecânicas'";
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, dificuldade FROM $tabela WHERE materia = 'Interferência e difração de ondas mecânicas' LIMIT $questoes_por_pagina OFFSET $offset";
...
$questoes_por_pagina = 1;
$offset = ($pagina_atual - 1) * $questoes_por_pagina;
$count_sql = "SELECT COUNT(*) AS total FROM $tabela WHERE materia = 'Interferência e difração de ondas mecânicas'";
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, dificuldade
    FROM $tabela WHERE materia = 'Interferência e difração de ondas mecânicas'";
if (count($conditions) > 0) {
...
<div class="page-container">
    <main class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <h3 class="font-weight-bold">Interferência e difração de ondas mecânicas</h3>
        </div>
