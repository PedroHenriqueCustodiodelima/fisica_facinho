...
$questao_sql = "SELECT id, enunciado, explicacao FROM $tabela WHERE materia = 'Hidrostática' LIMIT $offset, $questoes_por_pagina";
...
<head>
    ...
    <title>Tarefas - Hidrostática</title>
...
<div class="page-container">
    ...
    <main class="container">
        ...
        <h1 class="mt-4 mb-4">Atividades sobre Hidrostática</h1>
