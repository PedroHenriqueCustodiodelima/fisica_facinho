...
$total_questoes_sql = "SELECT COUNT(*) AS total FROM $tabela WHERE materia = 'Ondas mecânicas'";
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, dificuldade FROM $tabela WHERE materia = 'Ondas mecânicas' LIMIT $questoes_por_pagina OFFSET $offset";
...
$count_sql = "SELECT COUNT(*) AS total FROM $tabela WHERE materia = 'Ondas mecânicas'";
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, dificuldade
    FROM $tabela WHERE materia = 'Ondas mecânicas'";
...
<div class="page-container">
    <main class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <h3 class="font-weight-bold">Ondas mecânicas</h3>
        </div>
