...
$questao_sql = "SELECT id, enunciado, explicacao FROM $tabela WHERE materia = 'Hidrodinâmica' LIMIT $offset, $questoes_por_pagina";
...
<head>
    ...
    <title>Tarefas - Hidrodinâmica</title>
...
<div class="page-container">
    ...
    <main class="container">
        ...
        <h1 class="mt-4 mb-4">Atividades sobre Hidrodinâmica</h1>
