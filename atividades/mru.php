...
// Modificado para filtrar por 'Movimento retilíneo uniforme (MRU)'
...
$questao_sql = "SELECT id, enunciado, explicacao FROM $tabela WHERE materia = 'Movimento retilíneo uniforme (MRU)' LIMIT $offset, $questoes_por_pagina";
...
<head>
    ...
    <title>Tarefas - Movimento Retilíneo Uniforme (MRU)</title>
...
<div class="page-container">
    ...
    <main class="container">
        ...
        <h1 class="mt-4 mb-4">Atividades de Movimento Retilíneo Uniforme (MRU)</h1>
