...
$questao_sql = "SELECT id, enunciado, explicacao FROM $tabela WHERE materia = 'As Leis de Newton e suas aplicações' LIMIT $offset, $questoes_por_pagina";
...
<head>
    ...
    <title>Tarefas - As Leis de Newton e suas aplicações</title>
...
<div class="page-container">
    ...
    <main class="container">
        ...
        <h1 class="mt-4 mb-4">Atividades sobre As Leis de Newton e suas aplicações</h1>
