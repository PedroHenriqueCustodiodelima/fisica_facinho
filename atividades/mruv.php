...
$questao_sql = "SELECT id, enunciado, explicacao FROM $tabela WHERE materia = 'Movimento retilíneo uniformemente variado (MRUV)' LIMIT $offset, $questoes_por_pagina";
...
<head>
    ...
    <title>Tarefas - Movimento Retilíneo Uniformemente Variado (MRUV)</title>
...
<div class="page-container">
    ...
    <main class="container">
        ...
        <h1 class="mt-4 mb-4">Atividades de Movimento Retilíneo Uniformemente Variado (MRUV)</h1>
