...
// Modifiquei a consulta SQL para filtrar por 'Cinemática – conceitos básicos'
$total_questoes_sql = "SELECT COUNT(*) AS total FROM $tabela WHERE materia = 'Cinemática – conceitos básicos'";
...
$questao_sql = "SELECT id, enunciado, explicacao FROM $tabela WHERE materia = 'Cinemática – conceitos básicos' LIMIT $offset, $questoes_por_pagina";
...
<head>
    ...
    <title>Tarefas - Cinemática – Conceitos Básicos</title>
...
<div class="page-container">
    ...
    <main class="container">
        ...
        <h1 class="mt-4 mb-4">Atividades de Cinemática – Conceitos Básicos</h1>
