...
$total_questoes_sql = "SELECT COUNT(*) AS total FROM $tabela WHERE materia = 'Ondulatória – Difração e dispersão'";
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, dificuldade FROM $tabela WHERE materia = 'Ondulatória – Difração e dispersão' LIMIT $questoes_por_pagina OFFSET $offset";
...
$count_sql = "SELECT COUNT(*) AS total FROM $tabela WHERE materia = 'Ondulatória – Difração e dispersão'";
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, dificuldade
    FROM $tabela WHERE materia = 'Ondulatória – Difração e dispersão'";
if (count($conditions) > 0) {
...
<div class="page-container">
    <main class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <h3 class="font-weight-bold">Ondulatória – Difração e dispersão</h3>
        </div>
