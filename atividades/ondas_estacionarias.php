...
$total_questoes_sql = "SELECT COUNT(*) AS total FROM $tabela WHERE materia = 'Ondulatória – Ondas estacionárias'";
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, dificuldade FROM $tabela WHERE materia = 'Ondulatória – Ondas estacionárias' LIMIT $questoes_por_pagina OFFSET $offset";
...
$count_sql = "SELECT COUNT(*) AS total FROM $tabela WHERE materia = 'Ondulatória – Ondas estacionárias'";
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, dificuldade
    FROM $tabela WHERE materia = 'Ondulatória – Ondas estacionárias'";
...
<div class="page-container">
    <main class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <h3 class="font-weight-bold">Ondulatória – Ondas estacionárias</h3>
        </div>
