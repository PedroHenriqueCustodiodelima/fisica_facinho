...
$questao_sql = "SELECT id, enunciado, explicacao FROM $tabela WHERE materia = 'Trabalho energia potência' LIMIT $offset, $questoes_por_pagina";
...
<head>
    ...
    <title>Tarefas - Trabalho energia potência</title>
...
<div class="page-container">
    ...
    <main class="container">
        ...
        <h1 class="mt-4 mb-4">Atividades sobre Trabalho Energia Potência</h1>
