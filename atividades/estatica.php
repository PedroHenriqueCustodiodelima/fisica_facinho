...
$questao_sql = "SELECT id, enunciado, explicacao FROM $tabela WHERE materia = 'Estática' LIMIT $offset, $questoes_por_pagina";
...
<div class="page-container">
    ...
    <main class="container">
        ...
        <h1 class="mt-4 mb-4">Atividades sobre Estática</h1>
