...
$total_questoes_sql = "SELECT COUNT(*) AS total FROM $tabela WHERE materia = 'Eletricidade – Eletrostática – Potencial eletrostático'";
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, dificuldade FROM $tabela WHERE materia = 'Eletricidade – Eletrostática – Potencial eletrostático' LIMIT $questoes_por_pagina OFFSET $offset";
...
$questoes_por_pagina = 1;
$offset = ($pagina_atual - 1) * $questoes_por_pagina;
$count_sql = "SELECT COUNT(*) AS total FROM $tabela WHERE materia = 'Eletricidade – Eletrostática – Potencial eletrostático'";
$conditions = [];
if ($enunciadoFiltro) {
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, dificuldade
    FROM $tabela WHERE materia = 'Eletricidade – Eletrostática – Potencial eletrostático'";
if (count($conditions) > 0) {
...
<div class="page-container">
    <main class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <h3 class="font-weight-bold">Eletricidade – Eletrostática – Potencial eletrostático</h3>
        </div>
