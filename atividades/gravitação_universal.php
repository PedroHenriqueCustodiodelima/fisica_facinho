...
$questao_sql = "SELECT id, enunciado, explicacao FROM $tabela WHERE materia = 'Gravitação Universal' LIMIT $offset, $questoes_por_pagina";
...
<head>
    ...
    <title>Tarefas - Gravitação Universal</title>
...
<div class="page-container">
    ...
    <main class="container">
        ...
        <h1 class="mt-4 mb-4">Atividades sobre Gravitação Universal</h1>
