...
$total_questoes_sql = "SELECT COUNT(*) AS total FROM $tabela_questoes WHERE concurso = 'IME'";
...
$anos_distinct_sql = "SELECT DISTINCT ano FROM $tabela_questoes WHERE concurso = 'IME' ORDER BY ano ASC";
