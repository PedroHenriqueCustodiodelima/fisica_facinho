...
$total_questoes_sql = "SELECT COUNT(*) AS total FROM $tabela_questoes WHERE concurso = 'ITA'";
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, concurso FROM $tabela_questoes WHERE concurso = 'ITA' LIMIT $questoes_por_pagina OFFSET $offset";
...
$anos_distinct_sql = "SELECT DISTINCT ano FROM $tabela_questoes WHERE concurso = 'ITA' ORDER BY ano ASC";
...
$materias_distinct_sql = "SELECT DISTINCT materia FROM $tabela_questoes WHERE concurso = 'ITA' ORDER BY materia ASC";
...
$count_sql = "SELECT COUNT(*) AS total FROM $tabela_questoes WHERE concurso = 'ITA'";
$conditions = [];
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, concurso FROM $tabela_questoes WHERE concurso = 'ITA'";
if (count($conditions) > 0) {
