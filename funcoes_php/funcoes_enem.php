...
$total_questoes_sql = "SELECT COUNT(*) AS total FROM $tabela_questoes WHERE concurso = 'ENEM'";
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, concurso FROM $tabela_questoes WHERE concurso = 'ENEM' LIMIT $questoes_por_pagina OFFSET $offset";
...
$anos_distinct_sql = "SELECT DISTINCT ano FROM $tabela_questoes WHERE concurso = 'ENEM' ORDER BY ano ASC";
...
$materias_distinct_sql = "SELECT DISTINCT materia FROM $tabela_questoes WHERE concurso = 'ENEM' ORDER BY materia ASC";
...
$count_sql = "SELECT COUNT(*) AS total FROM $tabela_questoes WHERE concurso = 'ENEM'";
$conditions = [];
...
$questao_sql = "SELECT id, enunciado, resolucao, foto_enunciado, materia, ano, concurso FROM $tabela_questoes WHERE concurso = 'ENEM'";
if (count($conditions) > 0) {
